  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6">
        <div class="card">
          <img src="d3-1.jpg" class="card-img-top" alt="Design Preview">
          <div class="card-body">
          ...
          <div class="card-footer">
            <div class="author-info">
              <img src="f5 - Copy.jpg" alt="Author">
              <div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="card">
          <img src="d3-2.png" class="card-img-top" alt="Design Preview">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6">
        <div class="card">
          <img src="d3-3.png" class="card-img-top" alt="Design Preview">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6">
        <div class="card">
          <img src="d3-4.jpg" class="card-img-top" alt="Design Preview">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6">
        <div class="card">
          <img src="d3-5.png" class="card-img-top" alt="Design Preview">
          <div class="card-body">
          ...
          <div class="card-footer">
            <div class="author-info">
              <img src="f1 - Copy.jpg" alt="Author">
              <div>
                <div class="author-status">PRO</div>
              </div>
            </div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="card">
          <img src="d3-6.jpg" class="card-img-top" alt="Design Preview">
          <div class="card-body">
          ...
          <div class="card-footer">
            <div class="author-info">
              <img src="f6 - Copy.jpg" alt="Author">
              <div>
                <div class="author-status">PRO</div>
              </div>
            </div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="card">
          <img src="d3-7.png" class="card-img-top" alt="Design Preview">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-5">
        <div class="card">
          <img src="d3-8.png" class="card-img-top" alt="Design Preview">
          <div class="card-body">
      ...
      <div class="col-md-3 col-sm-6">
      <div class="card">
        <img src="id3-9.jpg" class="card-img-top" alt="Design Preview">
        <div class="card-body">
    ...
    <div class="col-md-3 col-sm-6">
      <div class="card">
        <img src="d3-10.png" class="card-img-top" alt="Design Preview">
        <div class="card-body">
    ...
    <div class="col-md-3 col-sm-6">
      <div class="card">
        <img src="d3-11.jpg" class="card-img-top" alt="Design Preview">
        <div class="card-body">
